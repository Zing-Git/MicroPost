...
@IonicPage()
@Component({
  selector: 'page-lista-todos-proveedores',
  templateUrl: 'lista-todos-proveedores.html',
})
export class ListaTodosProveedoresPage {
  ...
  cargarInicial() {
    ...
    this.proveedorService.postGetProveedoresDeComercio(this.idComercio).subscribe(result => {
      ...
      if (result) {
        ...
        this.resultProveedores = JSON.parse(ENV.PROVEEDORES);
        console.log(this.resultProveedores);
