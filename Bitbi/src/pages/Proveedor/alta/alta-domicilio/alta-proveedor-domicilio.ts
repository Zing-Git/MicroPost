...
import { AltaProveedorLoginPage } from '../alta-login/alta-proveedor-login';
...
@IonicPage()
@Component({
  selector: 'page-alta-proveedor-domicilio',
  templateUrl: 'alta-proveedor-domicilio.html',
})
export class AltaProveedorDomicilioPage {
  ...
  onSingin() {
    ...
    this.navCtrl.push(AltaProveedorLoginPage, { data: this.clienteViewModel});
  }
